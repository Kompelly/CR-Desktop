...
WebUI.click(findTestObject('CR-DESKTOP - SPANISH/Home page/Add prod - home page/Hero banner - 1 st'))
...
WebUI.click(findTestObject('CR-DESKTOP - SPANISH/Home page/Add prod - home page/Black variant'))
...
WebUI.click(findTestObject('CR-DESKTOP - SPANISH/Home page/Add prod - home page/Hero banner - 2nd'))
...
WebUI.click(findTestObject('CR-DESKTOP - SPANISH/Home page/Add prod - home page/middle tile - home page'))
...
WebUI.click(findTestObject('CR-DESKTOP - SPANISH/Home page/Add prod - home page/Neon orange varaint'))
