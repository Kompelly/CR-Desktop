...
WebUI.setText(findTestObject('CR-DESKTOP - SPANISH/Cart page/input update qunatity'), '4')
...
WebUI.setText(findTestObject('CR-DESKTOP - SPANISH/Cart page/input update qunatity'), '2')
...
String b = WebUI.getText(findTestObject('CR-DESKTOP - SPANISH/Cart page/Get price - subtotal- cart page'))
