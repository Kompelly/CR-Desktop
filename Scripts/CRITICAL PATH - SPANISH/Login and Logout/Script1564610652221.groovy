...
WebUI.click(findTestObject('CR-DESKTOP - SPANISH/Home page/Login/Account icon'))
...
WebUI.click(findTestObject('CR-DESKTOP - SPANISH/Home page/Login/a_View Addresses (0)'))
...
WebUI.click(findTestObject('CR-DESKTOP - SPANISH/Home page/Login/a_Return to Account Details'))

WebUI.delay(2)

WebUI.click(findTestObject('CR-DESKTOP - SPANISH/Home page/Login/a_Wishlist'))

WebUI.back()

WebUI.delay(2)

WebUI.click(findTestObject('CR-DESKTOP - SPANISH/Home page/Login/a_Logout'))
